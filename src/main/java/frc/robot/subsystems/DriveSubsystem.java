...
public class DriveSubsystem extends SubsystemBase {
  ...
  private CANSparkMax leftMotorBack  = new CANSparkMax(2, MotorType.kBrushless); 
  private CANSparkMax rightMotorFront =  new CANSparkMax(3, MotorType.kBrushless); 
  private CANSparkMax rightMotorBack = new CANSparkMax(4, MotorType.kBrushless); 
