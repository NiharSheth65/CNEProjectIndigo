...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    BUTTON_A.toggleOnTrue(new WristCommand(m_WristSubsystem, WristConstants.wristIntakePosition, false)); 

    BUTTON_B.toggleOnTrue(new WristCommand(m_WristSubsystem, WristConstants.wristRestPosition, false)); 
    
    BUTTON_X.toggleOnTrue(new WristCommand(m_WristSubsystem, WristConstants.wristShootPosition, false)); 

    BUTTON_Y.toggleOnTrue(new WristCommand(m_WristSubsystem, WristConstants.wristAboveIntakePosition, false)); 
