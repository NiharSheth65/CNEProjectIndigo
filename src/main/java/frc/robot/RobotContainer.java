...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_autoChooser.addOption("shoot and dock", m_shootAndDockCommand);
  ...
  private void defaultCommands(){
    ...
    m_IntakeSubsystem.setDefaultCommand(new IntakeCommand(m_IntakeSubsystem, m_LedSubsystem, 0, false));
  ...
  private void configureBindings() {
    ...
    BUTTON_RB.onTrue(new IntakeCommand(m_IntakeSubsystem, m_LedSubsystem, 1, false)); 
    BUTTON_RB.onFalse(new IntakeCommand(m_IntakeSubsystem, m_LedSubsystem, 0, false)); 

    // BUTTON_RB.onTrue(new OuttakeCommand(m_IntakeSubsystem, 1)); 
    // BUTTON_RB.onFalse(new OuttakeCommand(m_IntakeSubsystem, 0)); 
    
    BUTTON_LB.onTrue(new IntakeCommand(m_IntakeSubsystem, m_LedSubsystem,-0.7, false)); 
    BUTTON_LB.onFalse(new IntakeCommand(m_IntakeSubsystem, m_LedSubsystem, 0, false)); 

    BUTTON_A.toggleOnTrue(new WristCommand(m_WristSubsystem, 21.5, false)); 
    ...
    BUTTON_B.toggleOnTrue(new WristCommand(m_WristSubsystem, 1, false)); 
    // BUTTON_B.onTrue(new WristCommand(m_WristSubsystem, 30)); 
    
    BUTTON_X.toggleOnTrue(new WristCommand(m_WristSubsystem, 7, false)); 
    BUTTON_Y.toggleOnTrue(new WristCommand(m_WristSubsystem, 20, false)); 
    ...
    controller.axisGreaterThan(3, 0.5).toggleOnFalse(new IntakeCommand(m_IntakeSubsystem, m_LedSubsystem, 0, false)); 
    controller.axisGreaterThan(3, 0.5).toggleOnTrue(new IntakeCommand(m_IntakeSubsystem, m_LedSubsystem, 0.5, false)); 
  }
